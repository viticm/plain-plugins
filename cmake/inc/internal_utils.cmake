...
#   Plain Framework's CMakeLists.txt, and once via Google Mock's).
...
macro(config_compiler_and_linker)
  ...
  if (MSVC)
    ...
    if (MSVC_VERSION LESS 1400)  # 1400 is Visual Studio 2005
      ...
      # Compatibility warnings not applicable to Plain Framework.
  ...
  set(cxx_base_flags "${cxx_base_flags} -DPF_PLUGIN_CORE")
  ...
  set(cxx_use_own_tuple "${cxx_default} -DPF_USE_OWN_TR1_TUPLE=1")
